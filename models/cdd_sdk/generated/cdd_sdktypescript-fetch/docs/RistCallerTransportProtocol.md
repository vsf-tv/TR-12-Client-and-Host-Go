...
```typescript
import type { RistCallerTransportProtocol } from ''
...
const example = {
  ...
  "encryption": null,
} satisfies RistCallerTransportProtocol
...
const exampleParsed = JSON.parse(exampleJSON) as RistCallerTransportProtocol
