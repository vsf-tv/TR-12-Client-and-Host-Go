...
func (o *SrtCallerTransportProtocol) GetEncryption() DeviceEncryption {
...
// and a boolean to check if the value has been set.
func (o *SrtCallerTransportProtocol) GetEncryptionOk() (*DeviceEncryption, bool) {
	if o == nil || IsNil(o.Encryption) {
		return nil, false
	}
...
func (o *SrtCallerTransportProtocol) SetEncryption(v DeviceEncryption) {
	o.Encryption = &v
}
