...
func (o *SrtListenerTransportProtocol) GetEncryption() DeviceEncryption {
...
// and a boolean to check if the value has been set.
func (o *SrtListenerTransportProtocol) GetEncryptionOk() (*DeviceEncryption, bool) {
	if o == nil || IsNil(o.Encryption) {
		return nil, false
	}
...
func (o *SrtListenerTransportProtocol) SetEncryption(v DeviceEncryption) {
	o.Encryption = &v
}
