...
func (o *RistCallerTransportProtocol) GetEncryption() DeviceEncryption {
...
// and a boolean to check if the value has been set.
func (o *RistCallerTransportProtocol) GetEncryptionOk() (*DeviceEncryption, bool) {
	if o == nil || IsNil(o.Encryption) {
		return nil, false
	}
...
func (o *RistCallerTransportProtocol) SetEncryption(v DeviceEncryption) {
	o.Encryption = &v
}
